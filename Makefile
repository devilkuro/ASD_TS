#
# OMNeT++/OMNEST Makefile for OverSim
#
# This file was generated with the command:
#  opp_makemake -f --deep -O out -d src -X. -L../inet/out/$$\(CONFIGNAME\)/src -linet -KINET_PROJ=../inet
#

# Name of target to be created (-o option)
TARGET = OverSim$(EXE_SUFFIX)
...
clean:
	$(qecho) Cleaning...
	$(Q)-rm -rf $O
	$(Q)-rm -f OverSim OverSim.exe libOverSim.so libOverSim.a libOverSim.dll libOverSim.dylib
