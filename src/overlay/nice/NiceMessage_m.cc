...
NiceMulticastMessage& NiceMulticastMessage::operator=(const NiceMulticastMessage& other)
{
    ...
    this->nice_dataTimeStamp_var = other.nice_dataTimeStamp_var;
    this->seqNo_var = other.seqNo_var;
...
void NiceMulticastMessage::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->nice_dataTimeStamp_var);
    doPacking(b,this->seqNo_var);
...
void NiceMulticastMessage::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->nice_dataTimeStamp_var);
    doUnpacking(b,this->seqNo_var);
...
double NiceMulticastMessage::getNice_dataTimeStamp() const
{
    return nice_dataTimeStamp_var;
}

void NiceMulticastMessage::setNice_dataTimeStamp(double nice_dataTimeStamp_var)
{
    this->nice_dataTimeStamp_var = nice_dataTimeStamp_var;
}
...
int NiceMulticastMessageDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='n' && strcmp(fieldName, "nice_dataTimeStamp")==0) return base+2;
...
std::string NiceMulticastMessageDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return double2string(pp->getNice_dataTimeStamp());
...
bool NiceMulticastMessageDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setNice_dataTimeStamp(string2double(value)); return true;
